...
You might need to run `npm install babel-preset-stage-0` if you want to use the latest version of javascript.

-   `storybook` using `npx storybook`. Storybook is a quick way to get a component library up and running.
